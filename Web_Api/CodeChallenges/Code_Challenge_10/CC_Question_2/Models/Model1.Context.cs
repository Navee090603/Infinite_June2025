...
namespace CC_Question_2.Models
{
    using System;
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        [DbFunction("NorthwindEntities", "fn_getcus")]
        public virtual IQueryable<fn_getcus_Result> fn_getcus(string cname)
        {
            var cnameParameter = cname != null ?
                new ObjectParameter("cname", cname) :
                new ObjectParameter("cname", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_getcus_Result>("[NorthwindEntities].[fn_getcus](@cname)", cnameParameter);
        }
